...
{
    CIImage *overlay = [CIImage imageWithColor:(self.overlayColor!=nil ? [CIColor colorWithCGColor:self.overlayColor.CGColor] : [CIColor colorWithRed:1 green:0 blue:0 alpha:0.6])];
